                                ...
                                <?php
                                    ...
                                    if(isset($_POST['dni']) ){
                                        if(strlen($_POST['dni']) >= 1 ){
                                            $dni = $_POST['dni'];
                                            $sql ="DELETE FROM administrador WHERE DNIAdmin = $dni";
						...
						<div class="modal-body">
                            <form action="admi_administradores_eliminar.php" method="post" novalidate="novalidate">
                                <div class="alert alert-danger" role="alert">
									...
									<p>Estas a punto de eliminar a un administrador, tras realizar esta accion no hay vuelta atras.</p>
									<hr>
                                    <input name="dni" type="hidden" id="dni" value="<?php echo $DNI_ADMI; ?>">
								</div>
                                <div>
