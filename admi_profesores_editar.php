                                                ...
                                                if(isset($_POST['Clave']) && isset($_POST['Clave2'])){
                                                    if(strlen($_POST['Clave']) >= 1 && strlen($_POST['Clave2'])){
                                                        ...
                                                        if($clave == $clave2){
                                                            ...
                                                            $sql2 ="UPDATE persona SET Clave = $clave WHERE DNIPersona = $DNI_Profesor";
                                                            $resultado2= mysqli_query($conn, $sql2);
                                                            if(!$resultado){
                                                                ?>
                                                                    <br>
                                                                    <div class="text-center alert alert-danger" role="alert">
                                                                        ¡No se logro realizar el cambio!
                                                                    </div>
                                                                <?php
                                                            }else{
                                                                ?> 
        ...
        <div class="modal fade" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
				<div class="modal-dialog modal-sm" role="document">
					<div class="modal-content">
                        ...
                        <form action="admi_profesores_editar.php?variable=<?php echo $DNI_Profesor; ?>" method="post" novalidate="novalidate">
                            <div class="form-group">
